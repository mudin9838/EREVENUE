...
namespace PlanedBudgetPro.Controllers
{
    ...
    public class DailyController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            IPagedList<Customerd> OrderAndCustomerList = db.Customerds.Where(a => a.FisicalYearId != "1").OrderBy(c => c.ParentId).ThenByDescending(c => c.OrderDate).ToPagedList(page ?? 1, 10);
